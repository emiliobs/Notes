...
namespace Notes.Classes
{
    ...
    {
        //Aqui ingreso a las tablas de seguridad de la bd:
        private static ApplicationDbContext userContext = new ApplicationDbContext();

        //Aqui ingreso a las tablas del contexto(mis tablas) de la bd:
        ...
        {
            // Upload image
            string path = string.Empty;//ruta completa de la foto
            string pic = string.Empty;//ruta del nombre de la foto:
            ...
            if (file != null)
            {
                ...
                //aqui subo el archivo al servidor
                file.SaveAs(path);
